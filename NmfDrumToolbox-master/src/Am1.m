...
function [WD, HD, WH, HH, iterErr] = Am1(X, WD, rh, rhoThres, maxIter, sparsity, s)
...
for i = 1:maxIter
    ...
    [WD_new, WH_new] = TemplateAdaptation(WD, HD, WH, HH, rhoThres, adaptCoef, s);
    
    %//NMF decomposition
    [~, ~, ~, ~, err] = PfNmf(X, WD_new, [], WH_new, [], rh, sparsity, s);
